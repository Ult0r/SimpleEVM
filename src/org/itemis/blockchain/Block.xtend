...
class Block {
  ...
  def List<UnsignedByte[]> getFields() {
    ...
    fields.add(difficulty.trimTrailingZerosAndReverse)
    fields.add(number.trimTrailingZerosAndReverse)
    fields.add(gasLimit.trimTrailingZerosAndReverse)
    fields.add(gasUsed.trimTrailingZerosAndReverse)
    fields.add(timestamp.trimTrailingZerosAndReverse)
