...
abstract class EVMOperation {
  ...
  public static final EnumMap<OpCode, Triple<UnsignedByte, Pair<UnsignedByte, UnsignedByte>, Consumer<EVMRuntime>>> OP_INFO = {
    ...
    result.put(OpCode.ADDRESS,       Triple.of(new UnsignedByte(0x30), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::ADDRESS(it)]))               
    ...
    result.put(OpCode.ORIGIN,        Triple.of(new UnsignedByte(0x32), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::ORIGIN(it)]))               
    result.put(OpCode.CALLER,        Triple.of(new UnsignedByte(0x33), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::CALLER(it)]))               
    result.put(OpCode.CALLVALUE,     Triple.of(new UnsignedByte(0x34), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::CALLVALUE(it)]))               
    ...
    result.put(OpCode.CALLDATASIZE,  Triple.of(new UnsignedByte(0x36), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::CALLDATASIZE(it)]))               
    ...
    result.put(OpCode.CODESIZE,      Triple.of(new UnsignedByte(0x38), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::CODESIZE(it)]))               
    ...
    result.put(OpCode.GASPRICE,      Triple.of(new UnsignedByte(0x3A), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [EnvironmentalInformation::GASPRICE(it)]))               
    ...
    result.put(OpCode.COINBASE,      Triple.of(new UnsignedByte(0x41), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [BlockInformation::COINBASE(it)]))               
    result.put(OpCode.TIMESTAMP,     Triple.of(new UnsignedByte(0x42), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [BlockInformation::TIMESTAMP(it)]))               
    result.put(OpCode.NUMBER,        Triple.of(new UnsignedByte(0x43), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [BlockInformation::NUMBER(it)]))               
    result.put(OpCode.DIFFICULTY,    Triple.of(new UnsignedByte(0x44), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [BlockInformation::DIFFICULTY(it)]))               
    result.put(OpCode.GASLIMIT,      Triple.of(new UnsignedByte(0x45), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [BlockInformation::GASLIMIT(it)]))               
    result.put(OpCode.POP,           Triple.of(new UnsignedByte(0x50), Pair.of(new UnsignedByte(1),  UnsignedByte.ZERO),  [StackMemoryStorageAndFlowOperations::POP(it)]))               
    ...
    result.put(OpCode.JUMP,          Triple.of(new UnsignedByte(0x56), Pair.of(new UnsignedByte(1),  UnsignedByte.ZERO),  [StackMemoryStorageAndFlowOperations::JUMP(it)]))               
    ...
    result.put(OpCode.PC,            Triple.of(new UnsignedByte(0x58), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [StackMemoryStorageAndFlowOperations::PC(it)]))               
    result.put(OpCode.MSIZE,         Triple.of(new UnsignedByte(0x59), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [StackMemoryStorageAndFlowOperations::MSIZE(it)]))               
    result.put(OpCode.GAS,           Triple.of(new UnsignedByte(0x5A), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [StackMemoryStorageAndFlowOperations::GAS(it)]))               
    ...
    result.put(OpCode.PUSH1,         Triple.of(new UnsignedByte(0x60), Pair.of(UnsignedByte.ZERO,  new UnsignedByte(1)),  [PushOperations::PUSHN(1, it)]))               
    ...
    result.put(OpCode.SELFDESTRUCT,  Triple.of(new UnsignedByte(0xFF), Pair.of(new UnsignedByte(1),  UnsignedByte.ZERO),  [SystemOperations::SELFDESTRUCT(it)]))
    result
  }
