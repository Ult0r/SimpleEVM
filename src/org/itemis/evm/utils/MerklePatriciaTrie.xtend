...
//    println(_root.elements.get(0))
  ...
  static abstract class Node {
    ...
    def static Node fromTwoKeyValuePairs(MerklePatriciaTrie trie, NibbleList firstKey, UnsignedByte[] firstValue, NibbleList secondKey, UnsignedByte[] secondValue) {
