...
class UtilsTest {
  ...
  def void testGetNthByteOfInteger() {
    ...
    Assert.assertEquals(_0x03020100.getNthByteOfInteger(1), UnsignedByte.ONE)
  ...
  def void testToHex() {
    ...
    Assert.assertEquals(UnsignedByte.ONE.toHex, "1")
  ...
  @Test
  def void testKeccak() {
    Assert.assertEquals(keccak256("".bytes).toString,
      "0xC5D2460186F7233C927E7DB2DCC703C0E500B653CA82273B7BFAD8045D85A470")
    Assert.assertEquals(keccak256("abc".bytes).toString,
    ...
    Assert.assertEquals(
      keccak256(
        "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu".
          bytes).toString, "0xF519747ED599024F3882238E5AB43960132572B7345FBEB9A90769DAFD21AD67")
      }
    }
